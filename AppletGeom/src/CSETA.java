...
public class CSETA {
    ...
    public static void execute(CoordPanel panel) {
        ...
        if (pointsx.size() >= 2) {
            ...
            Layout.circum4.setText(Integer.toString(triglobalcircum));
            Layout.area4.setText(Integer.toString(triglobalarea));
            Layout.time4.setText(Integer.toString(triglobalarea));
        }
    }
}